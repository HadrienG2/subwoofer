        ...
        Inputs: FloatSequence<Element = Self::Float>,
    {
        ...
        operations::integrate_full::<_, _, ILP, false>(
            ...
            move |acc, elem| {
                ...
                //
                // - If elem is subnormal, this is the MIN of normal and 2, which is
                //   just normal since normal can't be greater than 2.
                ...
                // - After minimum with acc, which is smaller than 2, we are thus in
                //   range [0.75; 2[ which is a subset of initial range [0.5; 2[
                acc.mul_add(elem, normal).fast_min(T::splat(2.0))
            },
        );
    }
